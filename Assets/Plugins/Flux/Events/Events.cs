...
namespace Flux
{
    public static class Events 
    {
        ...
        { 
            ...
            public void Call(EventArgs args) => callback?.Invoke(args);
        }
        ...
        private class VoidRelay : EventRelay
        {
            ...
            public override void Call(EventArgs args) => callback();
        ...
        private class GenericRelay<T1,T2,T3> : EventRelay
        {
            ...
            public override void Call(EventArgs args)
            {
                if (args is WrapperArgs<T1,T2,T3> wrapperArgs) callback(wrapperArgs.ArgOne, wrapperArgs.ArgTwo, wrapperArgs.ArgThree);
            }
        ...
        private class GenericRelay<T1,T2,T3,T4> : EventRelay
        {
            ...
            public override void Call(EventArgs args)
            {
                if (args is WrapperArgs<T1,T2,T3,T4> wrapperArgs) callback(wrapperArgs.ArgOne, wrapperArgs.ArgTwo, wrapperArgs.ArgThree, wrapperArgs.ArgFour);
            }
        ...
        private class CastRelay<T> : EventRelay where T : EventArgs
        {
            ...
            protected override void OnSubscription(object method) => callback += (Action<T>)method;
            protected override void OnUnsubscription(object method) => callback -= (Action<T>)method;
        }
        #endregion
        ...
        public static void ResetFlagTranslation() => flagTranslator.Reset();
        ...
        public static void EmptyCall(Enum address) => Call(address, EventArgs.Empty);
        public static void Call(Enum address, EventArgs args)
        {
            var key = flagTranslator.Translate(address);
            wrappers[key].Call(args);
        }
        public static void ZipCall<T1>(Enum address, T1 argOne) => Call(address, new WrapperArgs<T1>(argOne));
        public static void ZipCall<T1,T2>(Enum address, T1 argOne, T2 argTwo) => Call(address, new WrapperArgs<T1,T2>(argOne, argTwo));
        public static void ZipCall<T1,T2,T3>(Enum address, T1 argOne, T2 argTwo, T3 argThree) => Call(address, new WrapperArgs<T1,T2,T3>(argOne, argTwo, argThree));
        public static void ZipCall<T1,T2,T3,T4>(Enum address, T1 argOne, T2 argTwo, T3 argThree, T4 argFour) => Call(address, new WrapperArgs<T1,T2,T3,T4>(argOne, argTwo, argThree, argFour));
        ...
        public static void RelayByVoid(Enum address, Action method) => Relay<VoidRelay>(address, method);
        public static void RelayByCast<T>(Enum address, Action<T> method) where T : EventArgs => Relay<CastRelay<T>>(address, method);
        public static void RelayByValue<T1>(Enum address, Action<T1> method) => Relay<GenericRelay<T1>>(address, method);
        public static void RelayByValue<T1,T2>(Enum address, Action<T1,T2> method) => Relay<GenericRelay<T1,T2>>(address, method);
        public static void RelayByValue<T1,T2,T3>(Enum address, Action<T1,T2,T3> method) => Relay<GenericRelay<T1,T2,T3>>(address, method);
        public static void RelayByValue<T1,T2,T3,T4>(Enum address, Action<T1,T2,T3,T4> method) => Relay<GenericRelay<T1,T2,T3,T4>>(address, method);
        ...
        public static void BreakVoidRelay(Enum address, Action method) => BreakRelay<VoidRelay>(address, method);
        public static void BreakCastRelay<T>(Enum address, Action<T> method) where T : EventArgs => BreakRelay<CastRelay<T>>(address, method);
        public static void BreakValueRelay<T1>(Enum address, Action<T1> method) => BreakRelay<GenericRelay<T1>>(address, method);
        public static void BreakValueRelay<T1,T2>(Enum address, Action<T1,T2> method) => BreakRelay<GenericRelay<T1,T2>>(address, method);
        public static void BreakValueRelay<T1,T2,T3>(Enum address, Action<T1,T2,T3> method) => BreakRelay<GenericRelay<T1,T2,T3>>(address, method);
        public static void BreakValueRelay<T1,T2,T3,T4>(Enum address, Action<T1,T2,T3,T4> method) => BreakRelay<GenericRelay<T1,T2,T3,T4>>(address, method);
